   ...
   <div class="rows">
     ...
     <div class="col-md-9">
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-10">
             <fieldset disabled> 
              <input type="password" name="password" class="form-control disabled" id="pwd" value="<?php echo $row['pass'] ?>" required>
             </fieldset> 
            </div>
          </div>
...
//If the Yes Delete (confim delete) button is click from the closable div proceed to delete
  ...
  <strong>Sorry! </strong>User with Id'. $id .' is not deleted  </div>');
        }
    }
